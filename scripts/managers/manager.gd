...
@onready var start_menu = preload("res://scenes/menus/StartMenu.tscn")
@onready var player_menu = preload("res://scenes/menus/PlayerMenu.tscn")
@onready var game_scene = preload("res://scenes/menus/GameScene.tscn")
...
@onready var upgrade_scene = preload("res://scenes/upgrades/Upgrade.tscn")
@onready var player_scene: PackedScene = preload("res://scenes/players/Player.tscn")
@onready var enemy_scene: PackedScene = preload("res://scenes/players/Enemy.tscn")
@onready var player_sprites: Array = [preload("res://sprites/players/plane_1_cyan.png"), preload("res://sprites/players/plane_2_magenta.png"), preload("res://sprites/players/plane_3_red.png"), preload("res://sprites/players/plane_4_green.png")]
